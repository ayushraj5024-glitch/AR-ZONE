...
export default function App() {
  ...
  if (isLoadingAuth) {
    return (
      <div className="min-h-screen bg-[#020503] flex items-center justify-center flex-col relative overflow-hidden">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-[var(--primary)]/10 via-transparent to-transparent opacity-50 blur-xl"></div>
         <motion.div 
         ...
         >
            <motion.span 
              ...
              className="ar-zone-logo text-5xl tracking-widest text-[var(--primary)]"
            >
              AR ZONE
            </motion.span>
            <div className="flex items-center gap-2">
              <motion.div animate={{ height: [10, 24, 10] }} transition={{ repeat: Infinity, duration: 1, ease: 'easeInOut', delay: 0 }} className="w-1.5 bg-[var(--primary)] rounded-full" />
              <motion.div animate={{ height: [10, 24, 10] }} transition={{ repeat: Infinity, duration: 1, ease: 'easeInOut', delay: 0.15 }} className="w-1.5 bg-[var(--primary)] rounded-full" />
              <motion.div animate={{ height: [10, 24, 10] }} transition={{ repeat: Infinity, duration: 1, ease: 'easeInOut', delay: 0.3 }} className="w-1.5 bg-[var(--primary)] rounded-full" />
            </div>
         </motion.div>
      </div>
    );
  ...
  return (
    <div className="h-dvh w-full overflow-hidden bg-[#020503] flex font-exo text-slate-200">
      ...
      {/* Sidebar */}
      <aside
        className={`fixed inset-y-0 left-0 z-50 flex flex-col bg-[#05100a] text-slate-300 border-r border-[var(--primary)]/20 transition-all duration-300 ease-in-out md:relative
      ...
      >
        <div className="h-16 flex items-center justify-between px-4 bg-[#030a06] shrink-0 relative overflow-hidden">
          ...
          {isSidebarOpen && (
            <div className="absolute -left-4 top-0 w-32 h-16 bg-[var(--primary)]/10 blur-2xl"></div>
          )}
          {isSidebarOpen && (
            <div className="flex flex-col justify-center w-full pr-2 relative z-10">
              ...
              <span className="text-[11px] text-[var(--primary)] font-medium tracking-wide drop-shadow-md">
          ...
          <button
            ...
            className="p-1.5 hover:bg-[var(--primary)]/10 rounded border border-transparent hover:border-[var(--primary)]/30 text-slate-400 hover:text-[var(--primary)] transition-colors"
          >
            <Menu size={20} />
          </button>
        </div>
                ...
                <div 
                  ...
                  className={`flex items-center justify-between px-3 py-2.5 rounded cursor-pointer transition-all duration-200 group group-hover:text-white ${
                    (currentView === 'stockists' || currentView === 'agent' || currentView === 'create_agent' || currentView === 'create_stockist') 
                      ? 'bg-[var(--primary)]/10 text-[var(--primary)] border border-[var(--primary)]/30 shadow-[0_0_10px_rgba(0,255,136,0.1)]' 
                      : 'text-slate-400 hover:bg-[var(--primary)]/5 border border-transparent'
                  }`}
                >
                  <div className="flex items-center space-x-3">
                    <div className={`${(currentView === 'stockists' || currentView === 'agent' || currentView === 'create_agent' || currentView === 'create_stockist') ? 'text-[var(--primary)]' : 'text-slate-400 group-hover:text-[var(--primary)]'}`}>
                      <Users size={20} />
                    </div>
                  ...
                  {isSidebarOpen && (
                    isManageExpanded ? 
                      ...
                      <ChevronRight size={16} className="text-slate-500 group-hover:text-[var(--primary)]" />
                  )}
                </div>
                  ...
                  <div className="pl-9 pr-2 space-y-1 py-1">
                    <div 
                      ...
                      className={`flex items-center space-x-3 px-3 py-2 rounded cursor-pointer transition-all duration-150 text-sm ${
                        (currentView === 'stockists' || currentView === 'create_stockist') ? 'text-[#f0b429] bg-[#f0b429]/10 font-medium' : 'text-slate-400 hover:text-white hover:bg-[var(--primary)]/10'
                      }`}
                    >
                      <Users size={16} />
                      <span>Stockists</span>
                    ...
                    <div 
                      ...
                      className={`flex items-center space-x-3 px-3 py-2 rounded cursor-pointer transition-all duration-150 text-sm ${
                        (currentView === 'agent' || currentView === 'create_agent') ? 'text-[#f0b429] bg-[#f0b429]/10 font-medium' : 'text-slate-400 hover:text-white hover:bg-[var(--primary)]/10'
                      }`}
                    >
                      <Users size={16} />
                      <span>Agent</span>
          ...
          <div className="space-y-1">
            {userRole === 'admin' && (
              <>
                ...
                >
                  <div className="flex items-center space-x-3">
                    <div className={`${(currentView === 'my_clients' || currentView === 'blocked_clients' || currentView === 'commission_limits') ? 'text-[var(--primary)]' : 'text-slate-400 group-hover:text-[var(--primary)]'}`}>
                      <UserCog size={20} />
                    </div>
                ...
                {isSidebarOpen && isManageClientsExpanded && (
                  <div className="pl-9 pr-2 space-y-1 py-1">
                    <div 
                      ...
                      className={`flex items-center space-x-3 px-3 py-2 rounded cursor-pointer transition-all duration-150 text-sm ${
                        currentView === 'my_clients' ? 'text-[#f0b429] bg-[#f0b429]/10 font-medium' : 'text-slate-400 hover:text-white hover:bg-[var(--primary)]/10'
                      }`}
                    >
                      <Users size={16} />
                    ...
                    <div 
                      ...
                      className={`flex items-center space-x-3 px-3 py-2 rounded cursor-pointer transition-all duration-150 text-sm ${
                        currentView === 'blocked_clients' ? 'text-[#f0b429] bg-[#f0b429]/10 font-medium' : 'text-slate-400 hover:text-white hover:bg-[var(--primary)]/10'
                      }`}
                    >
                      <Users size={16} />
                    ...
                    <div 
                      ...
                      className={`flex items-center space-x-3 px-3 py-2 rounded cursor-pointer transition-all duration-150 text-sm ${
                        currentView === 'commission_limits' ? 'text-[#f0b429] bg-[#f0b429]/10 font-medium' : 'text-slate-400 hover:text-white hover:bg-[var(--primary)]/10'
                      }`}
                    >
                      <IndianRupee size={16} />
          ...
          <div className="space-y-1">
            {userRole === 'admin' && (
              <>
                ...
                >
                  <div className="flex items-center space-x-3">
                    <div className={`${(currentView === 'collection_report' || currentView === 'company_ledgers' || currentView === 'my_stmt' || currentView === 'profit_loss') ? 'text-[var(--primary)]' : 'text-slate-400 group-hover:text-[var(--primary)]'}`}>
                      <BookOpen size={20} />
                    </div>
                ...
                {isSidebarOpen && isManageLedgersExpanded && (
                  <div className="pl-9 pr-2 space-y-1 py-1">
                    <div 
                      ...
                      className={`flex items-center space-x-3 px-3 py-2 rounded cursor-pointer transition-all duration-150 text-sm ${
                        currentView === 'collection_report' ? 'text-[#f0b429] bg-[#f0b429]/10 font-medium' : 'text-slate-400 hover:text-white hover:bg-[var(--primary)]/10'
                      }`}
                    >
                      <BarChart3 size={16} />
                    ...
                    <div 
                      ...
                      className={`flex items-center space-x-3 px-3 py-2 rounded cursor-pointer transition-all duration-150 text-sm ${
                        currentView === 'company_ledgers' ? 'text-[#f0b429] bg-[#f0b429]/10 font-medium' : 'text-slate-400 hover:text-white hover:bg-[var(--primary)]/10'
                      }`}
                    >
                      <BookOpen size={16} />
                    ...
                    <div 
                      ...
                      className={`flex items-center space-x-3 px-3 py-2 rounded cursor-pointer transition-all duration-150 text-sm ${
                        currentView === 'my_stmt' ? 'text-[#f0b429] bg-[#f0b429]/10 font-medium' : 'text-slate-400 hover:text-white hover:bg-[var(--primary)]/10'
                      }`}
                    >
                      <BarChart3 size={16} />
                      <span>My Stmt.</span>
                    ...
                    <div 
                      ...
                      className={`flex items-center space-x-3 px-3 py-2 rounded cursor-pointer transition-all duration-150 text-sm ${
                        currentView === 'profit_loss' ? 'text-[#f0b429] bg-[#f0b429]/10 font-medium' : 'text-slate-400 hover:text-white hover:bg-[var(--primary)]/10'
                      }`}
                    >
                      <IndianRupee size={16} />
      ...
      <main className="flex-1 flex flex-col min-w-0 h-dvh overflow-hidden bg-[#020503]">
        {/* Header */}
        <header className="h-16 bg-[#05100a]/80 backdrop-blur-md border-b border-[var(--primary)]/20 flex shrink-0 items-center justify-between px-4 lg:px-8 z-10 sticky top-0 shadow-[0_4px_20px_rgba(0,255,136,0.05)] text-slate-200">
          <div className="flex items-center space-x-4">
            <button 
              className="md:hidden p-2 -ml-2 text-[var(--primary)] hover:bg-[var(--primary)]/10 rounded border border-transparent hover:border-[var(--primary)]/30"
              onClick={() => setSidebarOpen(!isSidebarOpen)}
            >
              <Menu size={20} />
            </button>
          ...
          <div className="flex items-center space-x-3 sm:space-x-4">
            <div className="hidden lg:flex items-center space-x-2 text-sm font-semibold tracking-wider text-[var(--primary)]">
              <span className="w-2 h-2 rounded-full bg-[var(--primary)] animate-pulse shadow-[0_0_10px_rgba(0,255,136,1)]"></span>
              <span className="font-orbitron font-bold">SYSTEM ONLINE</span>
            </div>
            
            <div className="h-6 w-px bg-[var(--primary)]/20 hidden lg:block"></div>
        ...
        <div className="flex-1 overflow-auto bg-[#020503] text-slate-200">
          ...
          {/* Alert Banner */}
          <div className="bg-linear-to-r from-[var(--primary)]/10 to-[#020503] border-b border-[var(--primary)]/20 text-slate-200 px-4 py-3 flex items-center shadow-sm w-full overflow-hidden">
            <div className="bg-[var(--primary)]/20 p-1.5 rounded mr-3 shrink-0 border border-[var(--primary)]/30">
              <span className="w-2 h-2 rounded-full bg-[var(--primary)] animate-pulse block shadow-[0_0_8px_rgba(0,255,136,1)]"></span>
            </div>
            <div className="flex-1 min-w-0 overflow-hidden relative h-6">
              <div className="absolute top-0 left-0 text-sm font-medium whitespace-nowrap animate-[marquee_25s_linear_infinite] font-exo flex items-center gap-8 text-[var(--primary)]">
            ...
            <div className="ml-auto pl-4 hidden sm:block">
              {(currentView === 'live_casino' || currentView === 'casino_game' || currentView === 'royal_casino' || currentView === 'royal_casino_report' || currentView === 'check_casino_result') ? (
                <button onClick={() => setCurrentView('live_casino')} className="bg-[var(--primary)]/10 border border-[var(--primary)]/50 text-[var(--primary)] hover:bg-[var(--primary)] hover:text-[#020503] text-xs font-bold px-3 py-1.5 rounded uppercase tracking-wider transition-all shadow-sm font-orbitron">
                  Play Now
                </button>
              ) : (
                <button onClick={() => setCurrentView('live_matches')} className="bg-[var(--primary)]/10 border border-[var(--primary)]/50 text-[var(--primary)] hover:bg-[var(--primary)] hover:text-[#020503] text-xs font-bold px-3 py-1.5 rounded uppercase tracking-wider transition-all shadow-sm font-orbitron">
                  Live View
                </button>
              )}
            </div>
          ...
          {/* Footer */}
          <footer className="mt-8 border-t border-[var(--primary)]/20 bg-[#05100a] py-6 px-4 lg:px-8 text-xs font-medium tracking-wide text-slate-500 flex flex-col sm:flex-row justify-between items-center font-exo">
            <div>
              <span className="ar-zone-logo text-lg">AR ZONE</span> <span className="mx-2 text-[var(--primary)]/30">|</span> Powered By <span className="text-[#f0b429] font-bold">AR Gaming</span> <span className="mx-2 text-[var(--primary)]/30">|</span> Copyright © 2021-2026
            </div>
            <div className="mt-2 sm:mt-0 font-orbitron text-[var(--primary)]">
  ...
  return (
    <div
      ...
      className={`flex items-center space-x-3 px-3 py-2.5 rounded cursor-pointer transition-all duration-200 group ${
        active 
          ? 'bg-[var(--primary)]/10 text-[var(--primary)] border border-[var(--primary)]/30 shadow-[0_0_10px_rgba(0,255,136,0.1)]' 
          : 'text-slate-400 hover:bg-[var(--primary)]/5 hover:text-white border border-transparent'
      }`}
    >
      <div className={`${active ? 'text-[var(--primary)]' : 'text-slate-400 group-hover:text-[var(--primary)]'}`}>
        {icon}
      </div>
...
function NavGroup({ icon, label, isOpen }: { icon: React.ReactNode, label: string, isOpen: boolean }) {
  return (
    <div className="flex items-center justify-between px-3 py-2.5 rounded cursor-pointer transition-all duration-200 text-slate-400 hover:bg-[var(--primary)]/5 hover:text-white border border-transparent group">
      <div className="flex items-center space-x-3">
        <div className="text-slate-400 group-hover:text-[var(--primary)]">
          {icon}
        </div>
