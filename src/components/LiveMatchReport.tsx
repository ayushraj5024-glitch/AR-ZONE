...
export default function LiveMatchReport({ onNavigateBack, onGoToDashboard }: LiveMatchReportProps) {
    ...
    <div className="p-4 lg:p-8 max-w-[1400px] mx-auto space-y-6 font-sans text-sm pb-16">
      ...
      <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
        <div>
          ...
          <div className="text-sm text-slate-400 mt-2 flex items-center space-x-2 font-medium">
            ...
            <ChevronRight className="w-4 h-4 text-slate-400" />
            <span className="text-emerald-600">Live Report</span>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-4 gap-6">
        ...
        <div className="xl:col-span-3 space-y-6">
          ...
          <div className="bg-gradient-to-br from-slate-900 to-slate-800 rounded-2xl shadow-lg relative overflow-hidden border border-slate-700">
            {/* Background pattern */}
            ...
            <div className="relative p-6 px-8 flex flex-col md:flex-row items-center justify-between gap-6">
              <div className="flex-1 text-center md:text-left z-10 w-full">
                ...
                <h3 className="text-white text-3xl font-bold tracking-tight">Somerset</h3>
                <div className="mt-2 text-emerald-400 font-mono text-2xl font-semibold bg-emerald-500/10 inline-block px-4 py-1 rounded-lg border border-emerald-500/20">
                  202<span className="text-emerald-500/70 text-lg">/6</span> <span className="text-slate-400 text-base font-sans">(20.0)</span>
                </div>
              </div>
              ...
              <div className="flex-1 text-center md:text-right z-10 w-full">
                ...
                <h3 className="text-white text-3xl font-bold tracking-tight">Glamorgan</h3>
                <div className="mt-2 text-rose-400 font-mono text-2xl font-semibold bg-rose-500/10 inline-block px-4 py-1 rounded-lg border border-rose-500/20">
                  79<span className="text-rose-500/70 text-lg">/3</span> <span className="text-slate-400 text-base font-sans">(9.0)</span>
                </div>
              </div>
            </div>
        ...
        <div className="xl:col-span-1 space-y-6">
          ...
          <div className="bg-[#05100a] rounded-2xl shadow-sm border border-[#00ff88]/20 overflow-hidden flex flex-col min-h-[300px]">
          ...
          <div className="bg-[#05100a] rounded-2xl shadow-sm border border-[#00ff88]/20 overflow-hidden">
             ...
             <div className="divide-y divide-[#00ff88]/20 max-h-[400px] overflow-y-auto custom-scrollbar">
                {[
                  "Eagle Thane Strikers v Arcs Andheri",
                  "England v New Zealand",
                  "Surrey W v Essex W",
                  "Aakash Tigers MWS v North Mumbai Panthers",
                  "The Blaze W v Warwickshire W"
                ].map((m, i) => (
                  <div key={i} className="p-3 hover:bg-[#020503] cursor-pointer transition-colors group flex items-start gap-2 text-xs">
                     <div className="bg-indigo-100 text-indigo-600 font-bold px-1.5 py-0.5 rounded text-[10px] whitespace-nowrap mt-0.5">INPLAY</div>
                     <span className="text-slate-200 font-medium group-hover:text-indigo-600">{m}</span>
                  </div>
                ))}
             </div>
          </div>
